    ...
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-6 text-center">
        <div className="mb-8 md:mb-12">
          <div className="inline-flex items-center justify-center w-20 h-20 md:w-24 md:h-24  backdrop-blur-sm rounded-full mb-6 border border-white/20">
            <img
              className="w-16 h-20 color-white"
        ...
        <div className="relative max-w-2xl mx-auto">
          <div
            className={`
            relative bg-white/10 backdrop-blur-lg rounded-2xl p-2 border border-white/20
          ...
          >
            <form onSubmit={handleSubmit} className="flex items-center">
              ...
              <input
                ...
                className="
                  flex-1 bg-transparent text-white placeholder-white/60 px-4 py-4 md:py-5 
                  text-lg md:text-xl focus:outline-none font-medium
                "
              />
              ...
              <button
                type="submit"
                className="
                  group relative px-6 md:px-8 py-4 md:py-5 
            ...
            {['Harry Potter', 'Sci-Fi', 'Mystery', 'Romance', 'Biography'].map(
              (term) => (
                <button
                  ...
                  className="
                  px-3 py-1 text-sm bg-white/10 hover:bg-white/20 
